...
#BSUB -J blastx_20nodes         # job name
...
# look for available BLAST databases in the directory /scratch/datasets/BLAST/
# ls /scratch/datasets/BLAST/*.gz.md5 | cut -f 1 -d '.' | uniq
blast_db='/scratch/datasets/BLAST/nr'
evalue='0.001'
...
################################################################################
# This section does not need to be edited unless you want to add options to the blast command
