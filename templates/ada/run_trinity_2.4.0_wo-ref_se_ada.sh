...
#BSUB -J trinity_se_de_novo     # job name
...
########## INPUTS ##########
se_1='/scratch/datasets/GCATemplates/data/rnaseqc/e_coli/SRR958661_1.fastq.gz'
...
########## OUTPUTS #########
# output files are written to default directory trinity_out
...
Trinity --seqType $seqType --max_memory 53G --single $se_1 --CPU $threads --no_version_check --inchworm_cpu 6
