...
#BSUB -J art_illumina_pe        # job name
...
######## PARAMETERS ########
sequences_system='HS25'         # GA1, GA2, HS10, HS20, HS25, HSXn, HSXt, MSv1, MSv3, MinS, NS50
read_length=150
fold_coverage=90
...
########## OUTPUTS #########
output_prefix='c_dubliniensis_pe'

################################### COMMANDS ###################################
# Paired end reads witout printing alignments (-na)
art_illumina -p -i $input_fasta -l $read_length -ss $sequences_system -f $fold_coverage -o $output_prefix -m $mean_frag_size -s $stdev_frag_size -na
