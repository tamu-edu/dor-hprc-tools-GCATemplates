...
#BSUB -R "rusage[mem=24000]"    # reserves 500MB memory per core
#BSUB -M 24000                  # sets to 500MB per process enforceable memory limit. (M * n)
...
module load Canu/1.5-intel-2015B-Perl-5.20.0
...
######## PARAMETERS ########
assembly_directory="build_1.5_out"

genome_size='40m'               # supported units: g, m, k
# the OR74A_filtered_subreads.fastq sample data takes 2 hours to complete
