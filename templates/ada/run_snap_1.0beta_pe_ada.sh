...
#BSUB -n 5                      # assigns 5cores for execution
...
pe1_1='ERR551981_pe_1_trimmo.fastq.gz'
pe1_2='ERR551981_pe_2_trimmo.fastq.gz'
...
########## OUTPUTS #########
output_sam="out_ERR551981_pe.sam"
...
snap-aligner paired index_dir $pe1_1 $pe1_2 -o $output_sam
