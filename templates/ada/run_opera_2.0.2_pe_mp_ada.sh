...
config_file='opera_pe_mp_build.conf'

# FR 400 bp paired end reads
...
########## OUTPUTS #########
output_dir='opera_results_pe_mp'
...
[LIB]
map_file=opera_preprocess_pe.bam
cluster_threshold=5
lib_mean=400
lib_std=100
...
################################### COMMANDS ###################################
#
perl $OPERA_ROOT/bin/preprocess_reads.pl $contigs $pe1_1 $pe1_2  opera_preprocess_pe.bam bwa
