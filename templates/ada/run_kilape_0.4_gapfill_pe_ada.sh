...
#BSUB -J kilape_gapfill_pe      # job name
...
<<README
    ...
    - Output directories:
        kilape_working/iteration1/          # gapfilling utilizing velvet local assembly results
...
config_file='lib_params_gapfill.conf'
...
################################### COMMANDS ###################################
# gapfill using velvet assembler
perl $KILAPE_HOME/KILAPE.pl -a $scaffolds_file -c $config_file
