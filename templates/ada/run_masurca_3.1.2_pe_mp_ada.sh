...
########## INPUTS ##########
config_file='build_masurca_pe_mp.conf'
...
echo "DATA
PE= pe 300 20 $pe1_1 $pe1_2
# if JUMP mate pairs are oriented --->  <--- (FR, innies) then specify negative mean
JUMP= m2 -2000 1000 $mp2kb1_1 $mp2kb1_2
END
...
<<NOTES
    Estimated run time on E coli sample data: ~55 minutes; max memory ~16 Gb
        genome size 4.4Mb
