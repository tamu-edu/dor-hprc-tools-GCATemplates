...
module load BLAST+/2.4.0-intel-2017A
...
task='megablast'                # blastn, blastn-short, dc-megablast, megablast, rmblastn
...
additional_blast_options='-max_target_seqs 5'     # Example: -num_alignments 5
