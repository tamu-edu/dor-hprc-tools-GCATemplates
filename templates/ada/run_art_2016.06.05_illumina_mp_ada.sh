...
#BSUB -J art_illumina_mp        # job name
...
########## OUTPUTS #########
output_prefix='c_dubliniensis_mp'

################################### COMMANDS ###################################
# mate pair reads witout printing alignments (-na)
art_illumina -mp -i $input_fasta -l $read_length -ss $sequences_system -f $fold_coverage -o $output_prefix -m $mean_frag_size -s $stdev_frag_size -na
