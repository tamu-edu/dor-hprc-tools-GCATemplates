...
#BSUB -J kilape_scaf_gapfill    # job name
...
<<README
    ...
    - Output directories:
        ...
        kilape_working/iteration3/          # gapfilling utilizing velvet local assembly results   
...
########## INPUTS ##########
config_file='lib_pe_mp_scaffold_gapfill.conf'
...
################################### COMMANDS ###################################
# scaffold and gapfill using velvet assembler
