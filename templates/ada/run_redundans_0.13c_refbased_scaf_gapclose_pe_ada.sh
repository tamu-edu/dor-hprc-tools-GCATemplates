...
reference_genome='test/ref.fa'
pe_reads="test/600_?.fq.gz"

######## PARAMETERS ########
threads=20

########## OUTPUTS #########
out_dir='run_ref_pe-closing'
...
redundans.py -v -t $threads -i $pe_reads -r $reference_genome -f $assembly_contigs -o $out_dir --noscaffolding
