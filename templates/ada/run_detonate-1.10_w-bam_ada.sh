...
########## INPUTS ##########
assembled_transcripts='assembled_transcripts.fasta'
bam='seq_aln_2_transcripts.bam'
...
################################### COMMANDS ###################################
# 
rsem-eval-calculate-score --bam $bam $assembled_transcripts $sample_name $avg_length
